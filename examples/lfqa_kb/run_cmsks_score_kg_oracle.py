...
from primeqa.lfqa_kb.processors.preprocessors.eli5 import preprocess_eli5_function_cmsks_kg_oracle, preprocess_eli5_validation_function_cmsks_kg_oracle
    ...
    if training_args.do_train:
        ...
        with training_args.main_process_first(desc="train dataset map pre-processing"):
            train_dataset = train_dataset.map(
                preprocess_eli5_function_cmsks_kg_oracle,
    ...
    if training_args.do_eval:
        ...
        with training_args.main_process_first(desc="validation dataset map pre-processing"):
            eval_dataset = eval_examples.map(
                preprocess_eli5_validation_function_cmsks_kg_oracle,
                fn_kwargs=args_for_preprocess,
                batched=True,
                num_proc=data_args.preprocessing_num_workers,
                remove_columns=column_names,
