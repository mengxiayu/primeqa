...
output_dir="/dccstor/myu/experiments/knowledge_trie/eli5_openie_dev/"
...
/dccstor/myu/primeqa/primeqa/lfqa_kb/scripts/run_openie.py ${start} ${end} ${data_file} ${output_dir} ${port}\
